...
public class RubberIndicator extends FrameLayout {
    ...
    /** Paint to draw the outer circle **/
    ...
    public void pageUp(boolean up) {
        ...
        Log.d(TAG, "smallCircleCenter:(before)" + smallCircleCenter.x);

        float radius = (smallCircleCenter.x - smallCircleEndCenter.x) / 2;
        RectF oval = new RectF(smallCircleEndCenter.x, smallCircleEndCenter.y - radius, smallCircleCenter.x, smallCircleEndCenter.y + radius);
        ...
        mAnim = new AnimatorSet();
        mAnim.playTogether(smallCircleAnim, otherAnim, largeCircleAnim, outerCircleAnim);
        ...
        mAnim.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                mSmallCircleIndex = (mSmallCircleIndex + 1) % mSmallCircleViews.length;

                Log.d(TAG, "smallCircleCenter:" + mSmallCircle.getCenter().x);
            }
